...
class Islem:
    def _init_(self, aciklama, miktar):
...
class Hesap:
    def _init_(self, iban, hesap_adi, musteri, bakiye=0.0, borc=0.0, islemler=None):
        self.iban = iban
...
class Musteri:
    def _init_(self, tc, ad, soyad, sifre, hesaplar=None):
        self.tc = tc
        self.ad = ad
        self.soyad = soyad
        self.sifre = sifre
...
class Banka:
    def _init_(self, dosya_ad="data.json"):
